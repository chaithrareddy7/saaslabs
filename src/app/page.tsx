        ...
        <div className="max-w-[1200px] mx-auto px-4 sm:px-6 h-14 sm:h-16 flex items-center justify-between gap-4">
          <div className="flex items-center gap-6 lg:gap-10 min-w-0">
            ...
            <nav className="hidden lg:flex items-center gap-7 text-[15px] text-slate-700">
              {acf.nav_links && acf.nav_links.map((link: LinkItem, i: number) => (
                <a key={i} href={getUrl(link.url)} className="hover:text-slate-900 transition">
                  {link.label}
                </a>
              ))}
            </nav>
      ...
      <footer className="relative bg-[#001233] text-white overflow-hidden">
        <div className="relative z-10 w-full max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-10 py-8 sm:py-10 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6 lg:gap-8">
          <div className="text-[13px] sm:text-[14px] leading-[1.6] text-white">
            ...
            <p className="mt-2">{acf.footer_copyright}</p>
          </div>
